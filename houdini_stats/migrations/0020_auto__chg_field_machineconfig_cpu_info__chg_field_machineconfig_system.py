...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'houdini_stats_machineconfig', 'cpu_info', self.gf('django.db.models.fields.CharField')(max_length=60))

        # Changing field 'MachineConfig.system_resolution'
        db.alter_column(u'houdini_stats_machineconfig', 'system_resolution', self.gf('django.db.models.fields.CharField')(max_length=40))
