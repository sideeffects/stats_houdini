...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'houdini_stats_machine', 'hardware_id', self.gf('django.db.models.fields.CharField')(max_length=80))

        # Changing field 'LogId.log_id'
        db.alter_column(u'houdini_stats_logid', 'log_id', self.gf('django.db.models.fields.CharField')(max_length=80))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'LogId.log_id'
        db.alter_column(u'houdini_stats_logid', 'log_id', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'MachineConfig.config_hash'
        db.alter_column(u'houdini_stats_machineconfig', 'config_hash', self.gf('django.db.models.fields.CharField')(max_length=40))
