...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'houdini_stats_houdinicrash', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['houdini_stats.HoudiniCrashGroup']),
                      keep_default=False)
    ...
    models = {
        u'houdini_stats.houdinicrash': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['houdini_stats.HoudiniCrashGroup']"}),
