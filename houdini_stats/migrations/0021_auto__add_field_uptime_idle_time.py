...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Uptime.idle_time'
        db.add_column(u'houdini_stats_uptime', 'idle_time',
    ...
    def backwards(self, orm):
        db = dbs['stats']
        db.dry_run = south.db.db.dry_run
        # Deleting field 'Uptime.idle_time'
        db.delete_column(u'houdini_stats_uptime', 'idle_time')
