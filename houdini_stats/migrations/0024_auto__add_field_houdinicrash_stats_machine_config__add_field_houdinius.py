...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HoudiniCrash.stats_machine_config'
        db.add_column(u'houdini_stats_houdinicrash', 'stats_machine_config',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['stats_main.MachineConfig']),
                      keep_default=False)

        # Adding field 'HoudiniUsageLog.stats_machine_config'
        db.add_column(u'houdini_stats_houdiniusagelog', 'stats_machine_config',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['stats_main.MachineConfig']),
                      keep_default=False)

        # Adding field 'HoudiniToolUsage.stats_machine_config'
        db.add_column(u'houdini_stats_houdinitoolusage', 'stats_machine_config',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['stats_main.MachineConfig']),
                      keep_default=False)

        # Adding field 'HoudiniUsageCount.stats_machine_config'
        db.add_column(u'houdini_stats_houdiniusagecount', 'stats_machine_config',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['stats_main.MachineConfig']),
                      keep_default=False)

        # Adding field 'Uptime.stats_machine_config'
        db.add_column(u'houdini_stats_uptime', 'stats_machine_config',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['stats_main.MachineConfig']),
                      keep_default=False)

        # Adding field 'HoudiniUsageFlag.stats_machine_config'
        db.add_column(u'houdini_stats_houdiniusageflag', 'stats_machine_config',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['stats_main.MachineConfig']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'HoudiniCrash.stats_machine_config'
        db.delete_column(u'houdini_stats_houdinicrash', 'stats_machine_config_id')

        # Deleting field 'HoudiniUsageLog.stats_machine_config'
        db.delete_column(u'houdini_stats_houdiniusagelog', 'stats_machine_config_id')

        # Deleting field 'HoudiniToolUsage.stats_machine_config'
        db.delete_column(u'houdini_stats_houdinitoolusage', 'stats_machine_config_id')

        # Deleting field 'HoudiniUsageCount.stats_machine_config'
        db.delete_column(u'houdini_stats_houdiniusagecount', 'stats_machine_config_id')

        # Deleting field 'Uptime.stats_machine_config'
        db.delete_column(u'houdini_stats_uptime', 'stats_machine_config_id')

        # Deleting field 'HoudiniUsageFlag.stats_machine_config'
        db.delete_column(u'houdini_stats_houdiniusageflag', 'stats_machine_config_id')
