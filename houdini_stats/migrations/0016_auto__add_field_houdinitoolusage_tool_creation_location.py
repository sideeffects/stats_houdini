...
class Migration(SchemaMigration):
	...
	db = dbs['stats']
        ...
        db.add_column(u'houdini_stats_houdinitoolusage', 'tool_creation_location',
	...
	db = dbs['stats']
        ...
        # Deleting field 'HoudiniToolUsage.tool_creation_location'
        db.delete_column(u'houdini_stats_houdinitoolusage', 'tool_creation_location')
