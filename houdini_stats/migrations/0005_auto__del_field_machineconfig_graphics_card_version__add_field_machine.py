...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('houdini_stats_machineconfig', 'graphics_card_vendor', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('houdini_stats_machineconfig', 'graphics_card_vendor')
