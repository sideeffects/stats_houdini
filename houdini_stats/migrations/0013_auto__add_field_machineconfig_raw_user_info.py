...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MachineConfig.raw_user_info'
        db.add_column(u'houdini_stats_machineconfig', 'raw_user_info',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MachineConfig.raw_user_info'
        db.delete_column(u'houdini_stats_machineconfig', 'raw_user_info')
